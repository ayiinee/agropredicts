...
export default function Groups() {
  ...
  const [pestAlerts, setPestAlerts] = useState<PestAlert[]>([
    {
      ...
      description:
        "Hama blast terdeteksi dengan tingkat keparahan tinggi. Segera lakukan tindakan pencegahan.",
    ...
    },
    {
      ...
      description:
        "Brown spot terdeteksi pada tanaman padi. Perlu monitoring lebih lanjut.",
  ...
  useEffect(() => {
    ...
    if (pestDetectionData) {
      ...
      setShareMessage(
        `${pestDetectionData.probability}% ${pestDetectionData.name} terdeteksi pada tanaman. Tingkat keparahan: ${pestDetectionData.severity}. Segera lakukan tindakan pencegahan.`
      );
    }
  }, [pestDetectionData]);
  ...
  return (
    <RoleBasedLayout>
      <div className="space-y-6">
        ...
        {/* Peringatan Hama Terkini: dihapus sesuai permintaan */}
            ...
            <div className="space-y-4">
              {pestDetectionData && (
                <Alert>
                  ...
                  <AlertDescription>
                    {pestDetectionData.probability}% {pestDetectionData.name}{" "}
                    terdeteksi
                    <br />
